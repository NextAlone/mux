...
export const BUILTIN_SKILL_FILES: Record<string, Record<string, string>> = {
  ...
  "mux-docs": {
    ...
    "references/docs/hooks/tools.mdx": [
      ...
      "| `MUX_TOOL_INPUT_STATUSES_<INDEX>` | `statuses[<INDEX>]` | enum    | Task statuses to include. Defaults to active tasks: queued, starting, running, awaiting_report, pending, backgrounded. Pass ['interrupted', 'failed'] to discover workflow runs that may be resumable via workflow_resume.                                  |",
      "| `MUX_TOOL_INPUT_STATUSES_COUNT`   | `statuses.length`   | number  | Number of elements in statuses (Task statuses to include. Defaults to active tasks: queued, starting, running, awaiting_report, pending, backgrounded. Pass ['interrupted', 'failed'] to discover workflow runs that may be resumable via workflow_resume.) |",
      "",
      "</details>",
      "",
      "<details>",
      ...
      '| `MUX_TOOL_INPUT_SCRIPT_PATH`       | `script_path`       | string  | Explicit workflow script path, such as "skill://deep-research/workflow.js" or "./workflows/research.js".                                                                                                                                                                                                                                                                 |',
      "",
      "</details>",
      "",
    ...
    "references/docs/reference/cli.mdx": [
      ...
      "",
      "```bash",
      "# Run a packaged workflow script from a skill",
      'mux workflow run skill://workflow-smoke/workflow.js --args-json \'{"message":"hello"}\' --json',
      "",
      '# Run a trusted local workflow file with positional text, mapped to { "input": "research workflow runners" }',
      'mux workflow run ./workflows/research.js "research workflow runners"',
      "",
      "# Same as above, using the alias",
      'mux wf run ./workflows/research.js --args-json \'{"input":"workflow runners"}\' --json',
      "```",
      "",
      "### Workflow commands",
      "",

...
export const BUILTIN_SKILL_FILES: Record<string, Record<string, string>> = {
  ...
  "mux-docs": {
    ...
    "references/docs/reference/cli.mdx": [
      ...
      "",
      "<Note>",
      "  `mux workflow` is currently gated by the `dynamic-workflows` experiment. Pass `-e",
      "  dynamic-workflows` on each command, or enable the experiment in settings. The initial CLI runner",
      ...
      "| `--experiment <id>` / `-e`   | Enable an experiment, such as `dynamic-workflows`.                          |",

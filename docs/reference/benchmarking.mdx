...
| `MUX_TRUNK`           | Source bookmark or revision used when preparing the project                   | `main`                                 |
...
| `MUX_RUNTIME`         | Runtime type (`local`, `worktree` for JJ Workspace, or `ssh <host>`)          | `worktree`                             |

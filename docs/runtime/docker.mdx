...
2. Your project code is synced to `/src` inside the container via a repository bundle
...
Check "Share credentials" when creating a Docker workspace to enable repository authentication:

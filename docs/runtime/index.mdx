...
| **[JJ Workspace](/runtime/worktree)**      | Each workspace gets its own directory      | Running multiple agents in parallel         |
...
This lets your init hook adapt behavior, e.g., skip JJ Workspace-specific setup when running in local mode.
